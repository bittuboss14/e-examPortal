...
<h4  style="color:white;padding-top:40px;margin-left: px; "> Hello <?php echo $_SESSION['name']; ?>,your exam is going on</h4>
</div>
<div class="col-3">
...
<div class="jumbotron jumbotron-fluid" >
  <div class="container" >
   ...
   <p>Que.<?php echo $array['id']." "; ?><?php echo $array['question_2'] ?></p></li>
