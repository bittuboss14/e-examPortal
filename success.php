...
*/
  ...
  if(!isset($_SESSION['login']))
    header("Location:ass1.php?err12=1");
?>
...
<div class="container">
  <div class="jumbotron">
    ...
    <h2 class="text-success" style="text-align:center">Click <a href="ass1.php"><button type="button" class="btn btn-success">Here</button></a> to Log in</h2>
  </div>
