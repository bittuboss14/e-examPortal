...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-light navbar-custom bg-success ">
        <a class="navbar-brand" href="ass1.php"style="color:white;">Home</a>
...
<div><h1 class="display-1">My Wall</h1>
    <p>It was my first time using the website and it was so easy to use! I'm glad there's a platform like PosterMyWall to allow me to design a menu like a true professional</p>
</div>
